(() => {
  ...
  modal.innerHTML = '<div class="cinema-modal-frame"><button class="cinema-close" aria-label="Close video">×</button><b>Boomer\'s: Inside the Arena</b><p>Replace this presentation slot with Boomer\'s real lounge video.</p></div>';
  document.body.append(modal);
  $('.watch-inside')?.addEventListener('click', () => modal.classList.add('show'));
  $('.cinema-close', modal)?.addEventListener('click', () => modal.classList.remove('show'));
